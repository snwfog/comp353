...
--
-- Host: localhost
-- Generation Time: Nov 26, 2012 at 04:31 AM
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `getHotOffers`(IN p INT)
BEGIN
  SELECT * FROM offers o WHERE o.price < p AND o.expire != 1;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `get_hot_offers`(IN max INT)
BEGIN 
...
CREATE TABLE IF NOT EXISTS `addresses` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='http://stackoverflow.com/questions/217945/can-i-have-multipl' AUTO_INCREMENT=6 ;
...
(5, '7979 de madere', 'montreal', 'Quebec', 'Canada', 'h1z3c0');
...
(6, 5, 1, '1092380193809182', '1212', '123', 'mike');
...
--
-- in use(#1356 - View 'comp353.garages' references invalid table(s) or column(s) or function(s) or definer/invoker of view lack rights to use them)
-- in use (#1356 - View 'comp353.garages' references invalid table(s) or column(s) or function(s) or definer/invoker of view lack rights to use them)
...
(5, 'jew', '03ac674216f3e15c761ee1a5e255f067953623c8b388b4459e13f978d7c846f4', 5, 5, 5, NULL);
...
(37, 'Staring Contest', 'I will win', 0.00, 32, 'NULL', 0);
...
INSERT INTO `reserves` (`id`, `visitor_id`, `offer_id`, `reserve_time`) VALUES
(1, 7, 37, '2012-11-26 02:32:01'),
(4, 5, 37, '2012-11-26 04:02:52');
...
(97, 1, 'c5c178bf3737a1bf4223dffee1501d79be4a69f47fc1a1a8da571939d7310756', 1),
(98, 5, '40288d7cd747b761c2c7d32a8e5cbaf3922bc5cf3216d7d13089bef3b50d1696', 1),
(99, 5, '13631770156ee9ab2ae9d5329a746dcb0cb6d645b0b46568493a8711f920179f', 1),
(100, 1, 'ae30493b14615d350712f6c303f91bcd6a6d99587477b60ff4e4549638670461', 1),
(101, 1, '8c360a1fbefb89c45cfb6d0488fef3540b2cd42dba3a0fa7fdcc4825a5986fd6', 1),
(102, 5, '4203174563079ce5aed3d2bca1c2f1424cd3c7d02faeb4683e4b7a8c08402e68', 0),
(103, 1, '58a9be4e7e15e614be89f31dd5b1b65b05c1883eed5c1f583eb775de6b0374eb', 0),
(104, 2, '73a1dd31e35c8c1ef3feebd57cfdddd29d7d38daf7fe628cfc3f080517a742a0', 0);
...
INSERT INTO `storages` (`id`, `transact_id`, `acquire_date`, `pickup_date`, `weight`) VALUES
(1, 3, '2012-11-23', '2012-11-24', NULL);
...
(5, 'mike', 'pham', '5142911196', '2012-11-24'),
(7, 'mike', 'mike', '5142911196', '2012-11-25');
